...
public class CommentReportDetailsDTO {
    ...
    public CommentReportDetailsDTO(Long id, Long reportingUser, Long reportedUser, String reason, String reportingUserName, String reportedUserName, String reportStatus) {
        this.id = id;
